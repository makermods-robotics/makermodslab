...
def _build_teleoperation_request(record: dict, opts: TeleoperationOptions):
    ...
    return TeleoperateRequest(
        ...
        gripper_closing_error_deg=record.get("gripper_closing_error_deg"),
        gripper_leader_hold_gap_deg=record.get("gripper_leader_hold_gap_deg"),
        gripper_current_limit_ratio=record.get("gripper_current_limit_ratio"),
        gripper_max_velocity_deg_s=record.get("gripper_max_velocity_deg_s"),
