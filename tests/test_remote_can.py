...
def test_native_remote_devices_have_the_same_wire_schema(monkeypatch, tmp_path, family, mode):
    ...
    monkeypatch.setattr(robot_factory, "setup_follower_calibration_file", lambda *args: None)
    monkeypatch.setattr(robot_factory, "setup_leader_calibration_file", lambda *args: None)
    monkeypatch.setattr(robot_factory, "stage_bimanual_follower_calibrations", lambda *args: (tmp_path, None))
    monkeypatch.setattr(robot_factory, "stage_bimanual_leader_calibrations", lambda *args: (tmp_path, None))
