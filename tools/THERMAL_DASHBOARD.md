...
Reaching 110°C on any motor ends repetition and requests a bounded return to captured
...
All live tools use `makermodslab/thermal_limits.py`: return/alert at **110°C or higher**,
...
this cutoff cannot promise an absolute peak below 110°C.
