 ...
 * user sees before doing anything else. Covers finding an existing policy,
...
export const launchpadTour: Tour = {
  ...
  steps: [
    ...
    {
      target: "[data-tour=launchpad-policies]",
      titleKey: "onboarding.launchpad.policies.title",
      descriptionKey: "onboarding.launchpad.policies.description",
    },
    {
      target: "[data-tour=launchpad-new-policy]",
      titleKey: "onboarding.launchpad.newPolicy.title",
      descriptionKey: "onboarding.launchpad.newPolicy.description",
    },
    {
...
/**
 * First-run tour shown once the first time a user opens the Policy studio —
