...
import { armLabel, type ArmType } from "@/lib/armTypes";

const ARM_ICONS: Partial<Record<ArmType, string>> = {
  maker: makerArmPhoto,
  metal: metalArmPhoto,
  so101: so101ArmPhoto,
};
        ...
        {loading ? (
          ...
          >
            {hostable.map((name) => {
              ...
              const armName = armLabel(armById(armType), armType, t);
              ...
              return (
                ...
                >
                  ...
                  <img
                    src={ARM_ICONS[armType] ?? so101ArmPhoto}
                    alt={armName}
                    title={armName}
                    width={40}
                    height={30}
