...
/**
 * Live numeric joint readout for families without a shipped URDF.
 * The built-in SO-101, Maker, and Metal arms show their 3D models; CAN
 * telemetry also includes raw motor angles under `joints_deg`.
 *
