...
export default {
  ...
  gripperSoftLimit: {
    ...
    enabled: "已启用",
    disabled: "已禁用（原始行为）",
    description: "闭合时，限制夹爪目标位置超出实测位置的幅度。数值越小，持续挤压越弱；张开仍保持灵敏。这不保证实际力或扭矩的上限。",
    degrees: "最大闭合误差（度）",
    invalid: "请输入大于 0 的有限数值。系统不预设安全限值。",
    help: "数值越小，持续挤压越弱。请根据夹爪和物体选择数值。",
    scope: "仅从下一次本地遥操作或录制会话开始生效。",
    scopeBimanual: "仅从下一次本地遥操作或录制会话开始对两个夹爪生效。",
  },
  ...
  gripperLeaderHold: {
    ...
    enabled: "已启用",
    disabled: "已禁用（原始行为）",
    description: "当你握持主手夹爪的力度超过从手能夹住物体的程度时，短暂将主手夹爪手柄锁定，让你感受到“到底”的阻力，而不是让从手堵转。保持会脉冲式松放——把手柄往张开方向拉即可解除。",
    degrees: "触发间隙（度）",
    invalid: "请输入大于 0 的有限数值。系统不预设安全间隙。",
    help: "手柄需要超过从手实际位置多少度才会触发保持。数值越大，触发越晚。",
    requirements: "需要带电机的 Star Arm 102 主手（无法自动识别无电机的主手——若你的主手没有夹爪舵机，请保持关闭）。目前仅支持单臂。",
    scope: "仅从下一次本地遥操作或录制会话开始生效。",
  },
  ...
  window: {
    ...
    discard: {
      title: "放弃未保存的更改？",
      description:
        "你还有未保存的配置更改（端口、摄像头、电机力矩或夹爪设置）。现在关闭会丢弃这些更改 — 它们尚未写入机器人。若要保留，请先保存。",
      cancel: "继续编辑",
      confirm: "放弃并退出",
    },
    abort: {
